...
> Важно! Процесс окончательной установки HTTPS, а также DNS-записи для вашего домена довольно не быстрый - новые правила начинают работать в сети Интернет от пары часов до 1 суток. 
>
> Для целей тестирования и экспериментов с вызовом Game Service API, пока ожидаем включение новых правил, как вариант можно воспользоваться утилитами типа ngrok и localtunnel, которые на короткое время создают публичный http/https-туннель до вашей виртуалки. Подробнее об этом может быть добавлена секция в эту документацию в будущем.
